<template>
  <div id="mapa">
    <div style="width:100%;">
      ...
      <img v-if="this.nivel.fourth && !this.level.fifthLevel" src="../../assets/done4.png" alt="" id="trilha" usemap="#Map" border="0" width="100%"/>
    ...
    <map name="Map" id="Map">
      ...
      <area v-if="this.nivel.second" href="#/deriv-q3" shape="poly" coords="409,365,408,364,444,379,459,405,448,434,416,448,385,442,367,425,363,397,374,378,391,366" />
      <area v-if="this.nivel.third" href="#/deriv-q4" shape="poly" coords="521,520,521,519,560,537,576,568,569,595,542,614,513,617,485,607,465,586,469,558,480,539,499,526" />
      <area v-if="this.nivel.fourth && !this.level.fifthLevel" href="#/identitytrigonometric" shape="poly" coords="743,394,744,394,773,403,788,428,784,450,762,465,725,463,703,443,704,421,720,401" />
