<template>
  <div id="mapa">
    <div style="width:100%;">
      ...
      <img v-if="this.nivel.third && !this.level.fourthLevel" src="../../assets/done3.png" alt="" id="trilha" usemap="#Map" border="0" width="100%"/>
    ...
    <map name="Map" id="Map">
      ...
      <area v-if="this.nivel.third && !this.level.fourthLevel" href="#/integralsimpleradio" shape="poly" coords="521,520,521,519,560,537,576,568,569,595,542,614,513,617,485,607,465,586,469,558,480,539,499,526" />
